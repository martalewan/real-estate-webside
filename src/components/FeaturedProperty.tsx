        ...
        <section className="container py-24">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                    <h2 className="font-serif text-4xl">Villa Aurora</h2>
                    ...
                    <div className="text-sm text-gray-500 space-y-1">
                        ...
                        <p>6 Bedrooms • 7 Bathrooms • 850 m²</p>
                        <p className="text-black font-medium">$18,500,000</p>
                    </div>

                    <div className="flex gap-4 pt-2">
                        <button className="btn">View Property</button>
                        <button className="btn-secondary">Request Private Tour</button>
                    </div>
                </div>
